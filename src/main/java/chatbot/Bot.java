...
public class Bot {
	...
	Commands[] commandlist = {new Rename(), new AbandonShip(), new IBMarks(), new CheckVC(), new Help(), new Ban(), new Vaporize(), new Quiz(), new Bilingual()};
	Moderations[] moderationlist = {new TyrantSlurs(), new PingRemover(), new FirstQuote(), new SecondQuote(), new ThirdQuote(), new ForthQuote(), new FifthQuote(), new VerbTest()};
